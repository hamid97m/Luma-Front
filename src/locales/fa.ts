...
export const fa = {
  ...
  splash: {
    ...
    messagesWomen: [
      'لوما با تمرکز بر امنیت خانم‌ها ساخته شده است',
      'جای امن برای خانم‌ها — با خیال راحت آشنا شو',
    ],
  },
  next: 'ادامه',
  save: 'ذخیره',
  ...
  rewind: {
    ...
    body: 'اشتباهی رد کردی؟ با پرمیوم می‌توانی به پروفایل قبلی برگردی و دوباره تصمیم بگیری. این امکان مخصوص اعضای پرمیوم است.',
    getPremium: 'دریافت پرمیوم',
    cancel: 'انصراف',
    paywallSubtitle: 'برای دیدن پروفایل قبلی پرمیوم شو',
  },
  match: {
    title: 'مچ شدید!',
  ...
  block: {
    action: 'بلاک کاربر',
    title: (name: string) => `${name} بلاک شود؟`,
    body: 'دیگر نمی‌تواند برایت پیام بفرستد یا پروفایلت را ببیند. این چت از فهرست مچ‌هایت حذف می‌شود. او از بلاک شدن باخبر نمی‌شود.',
    confirm: (name: string) => `بلاک ${name}`,
    cancel: 'انصراف',
  },
  support: {
    title: 'پشتیبانی',
  ...
  directChat: {
    title: 'گفتگوی مستقیم',
    body: 'معمولاً فقط وقتی می‌توانی گفتگو را شروع کنی که هر دو همدیگر را لایک کرده باشید. با اشتراک ویژه می‌توانی بدون لایک متقابل، مستقیم پیام بدهی.',
    startCta: 'شروع گفتگو',
    ...
    paywallSubtitle: 'با اشتراک ویژه می‌توانی بدون نیاز به لایک متقابل، مستقیم پیام بدهی.',
  },
  ...
  onboarding: {
    ...
    useTelegramName: 'استفاده از نام تلگرام',
    ageQ: 'چند سال داری؟',
    ...
    added: 'اضافه شد ✓',
    useTelegramPhoto: 'استفاده از عکس تلگرام',
    telegramPhotoFailed: 'دریافت عکس تلگرام ناموفق بود. لطفاً یک عکس انتخاب کن.',
    ...
    realPhotosWomen:
      'خیالت راحت 💛 لوما با تمرکز بر امنیت خانم‌ها ساخته شده و پروفایلت جایی بیرون از اپ دیده نمی‌شود. به ما اعتماد کن و عکس واقعی خودت را بگذار تا شانس آشنایی‌ات چند برابر شود.',
  ...
  referral: {
    sheetTitle: 'دعوت از دوستان',
    entryTitle: 'دوستاتو دعوت کن، اشتراک رایگان بگیر',
    entrySub: 'با 3 دوست، 3 روز پرمیوم هدیه می‌گیری',
    headlineDefault: 'با هر دعوت، به پرمیوم نزدیک‌تر شو',
    headlineReward: 'یک مرحله دیگر رفتی جلو',
    headlineComplete: 'همه پاداش‌ها را گرفتی',
    subFresh: 'لینکت را بفرست؛ اولین دوستی که عضو شود 20 دیسکاوری اضافه برایت باز می‌کند.',
    subProgress: 'لینکت را بفرست و با هر دوستی که عضو شود یک پله بالا برو.',
    subReward: 'پاداش این مرحله روی حسابت نشست.',
    subComplete: 'مرسی که لوما رو به دوستات معرفی می‌کنی 💛',
    progressFresh: 'هنوز دعوتی ثبت نشده',
    progressOf: (n: number, m: number) => `${n} از ${m} دوست عضو شدند`,
    progressDone: (n: number) => `${n} دوست عضو شدند`,
    stage: (s: number) => `مرحله ${s} از 3`,
    stageComplete: 'هر 3 مرحله کامل',
    friendCount: (n: number) => `${n} دوست`,
    tierSwipes: (n: number) => `${n} دیسکاوری اضافه`,
    tierPremium: (d: number) => `${d} روز پرمیوم`,
    chipDone: 'گرفتی',
    chipJustDone: 'تازه گرفتی',
    chipRemaining: (n: number) => `${n} دوست دیگر`,
    rewardBannerPremium: (d: number) => `${d} روز پرمیوم گرفتی! 🎉`,
    rewardBannerSwipes: (n: number) => `${n} دیسکاوری اضافه گرفتی! 🎉`,
    rewardBannerUntil: (date: string) => `همین حالا فعال شد — تا ${date}`,
    rewardBannerAdded: 'همین حالا به حسابت اضافه شد',
    continueCta: 'ادامه بده',
    nextTierNote: (n: number, reward: string) => `${n} دوست دیگر تا ${reward}`,
    inviteCta: 'دعوت از دوستان',
    copyAria: 'کپی لینک',
