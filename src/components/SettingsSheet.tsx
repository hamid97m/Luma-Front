      ...
      <div className="glass border border-white/15 rounded-3xl p-6 w-full max-w-sm shadow-2xl">
        {view === 'menu' ? (
          <>
            ...
            <div className="glass border border-white/12 rounded-2xl p-4 mb-4">
              <div className="flex items-center justify-between mb-1">
                ...
                <button
                  ...
                  disabled={pausing}
                  onClick={togglePause}
                  className={`w-12 h-7 rounded-full transition-colors relative ${!isActive ? 'bg-[#ec4067]' : 'bg-white/20'}`}
                >
                  <span
